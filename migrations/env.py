...
from a4app.orders.models import PlacedOrder, OrderProduct, Address
...
config.set_section_option(section, 'POSTGRES_DATABASE_NAME',
                          get_settings().postgres_database_name)
fileConfig(config.config_file_name)
